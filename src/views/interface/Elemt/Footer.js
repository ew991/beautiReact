...
class SiteFooter_ extends React.Component {
    ...
    render() {
        return (
            <>
                <div className="SiteFooter lg:relative w-[100%] lg:h-[697px] " style={{ backgroundImage: `url(${footerBg})`, backgroundRepeat: 'no-repeat' }}>
                    <img className=" absolute mt-[248px] left-[150px] max-lg:hidden" src={Logo} alt="" />
                    <div className="BtnTotop " onClick={() => {
                        window.scrollTo({ top: 0, left: 0, behavior: 'smooth' });
                    }}>
                        <button className="absolute lg:mt-[500px] max-lg:mt-[250px] max-lg:ml-[65px] lg:right-[65px] h-[36px] w-[36px] rounded-[5px] cursor-pointer" style={{ backgroundImage: `url(${buttonToTopBG})` }} ></button>
                    </div>
                    <div className="logoim flex lg:ml-[150px] lg:gap-[150px] lg:pt-[220px] max-lg:pt-[100px] max-lg:mb-[30px] max-lg:grid max-lg:grid-cols-3 max-lg:ml-[50px]" >
                        <img className=" lg:hidden max-lg:block  " src={Logo} alt="" />
                        <div className="trais  text-[#D7DBFF] font-medium max-lg:col-span-2  ">

                            <p className=" lg:mt-[115px] ml-7 tracking-wides italic"><strong>Beautice </strong>is a Beauty Clinic WordPress Theme.</p>
                            ...
                            <span className="  underline decoration-slice italic max-sm:hidden">mail@company.com. </span>
                            <p className=" hidden underline decoration-slice italic max-sm:block ml-7">mail@company.com. </p>
                        </div>

                        <div className="w3-a text-[#D7DBFF] max-sm:col-start-1 max-lg:col-start-2 max-lg:mt-9 lg:flex lg:flex-col lg:gap-[10px]  " >
                            <h3 className=" text-lg ">Pages</h3>
                            <li className="lg:mt-[20px]"> <a href="#">Home</a></li>
                            <li> <a href="#About">About</a></li>
                            <li> <a href="#Service">Services</a></li>
                            <li> <a href="#Gallery">Gallery</a></li>
                            <li> <a href="#Blog">Team</a></li>
                        </div>
                        <div className="w3-a lg:ml-[50px] text-[#D7DBFF] max-sm:col-start-3 max-lg:mt-9 lg:flex lg:flex-col lg:gap-[10px]  ">
                            <h3 className=" text-lg">Informations</h3>
                            <li className="lg:mt-[20px]"> <a href="#">Terms & conditions</a></li>
                    ...
                    <div className="iconContact flex gap-[340px]   max-lg:gap-10 max-lg:hidden">
                        <div className="icn mt-36 flex pl-[188px] gap-[45px] items-center ">
                        ...
                        <div className="hreff mt-36  text-[#D7DBFF]">
                    ...
                    <div className="lg:hidden h-[50px] flex max-lg:justify-center max-lg:items-center max-sm:h-[100px]" style={{ backgroundImage: `url(${bottomFooterBG})` }}>
                        <div className="iconContact flex lg:gap-[340px]  max-lg:gap-[190px] max-sm:flex-col max-sm:gap-4">
                            <div className="icn lg:mt-36 flex items-center lg:pl-[188px] gap-[45px] ">
                                <svg width="15" height="28" viewBox="0 0 15 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M13.3174 15.6593L14.0117 10.6212H9.67041V7.35173C9.67041 5.97339 10.2769 4.62984 12.2212 4.62984H14.1948V0.340373C14.1948 0.340373 12.4038 0 10.6914 0C7.11621 0 4.7793 2.41306 4.7793 6.78136V10.6212H0.805176V15.6593H4.7793V27.8388H9.67041V15.6593H13.3174Z"
                                        fill="white" />
                            ...
                            <div className="hreff lg:mt-36  text-[#D7DBFF]">
                                <p>© AltDesain Studio 2021 - All right reserved.</p>
                            </div>

                        </div>
                    </div>
                    <img className=" absolute bottom-0 -z-30 max-lg:hidden" src={bottomFooterBG} />
                </div>
            </>
        )
    }
